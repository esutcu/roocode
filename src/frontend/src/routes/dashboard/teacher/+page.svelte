    ...
    <div class="px-4 py-6 sm:px-0">
      <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
          <h1 class="text-lg leading-6 font-medium text-gray-900">Teacher Dashboard</h1>
          <p class="mt-1 max-w-2xl text-sm text-gray-500">Manage your teaching sessions</p>
        </div>
              ...
              <div class="bg-blue-50 overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-blue-50 px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm font-medium text-blue-600">
                      <a href="/bookings/new">Create New Session</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-purple-50 overflow-hidden shadow rounded-lg">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0">
                      <dl>
                        ...
                        <dd class="text-3xl font-semibold text-gray-900">42%</dd>
                      </dl>
                    </div>
                  </div>
                </div>
                <div class="bg-purple-50 px-4 py-4 sm:px-6">
                  <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm font-medium text-purple-600">
                      <a href="/progress/achievements">Achievements</a>
                    </div>
                  </div>
                </div>
              </div>
